...
.. image:: https://img.shields.io/badge/GitHub-ts__rotgui-green.svg
    :target: https://github.com/lsst-ts/ts_rotgui
.. image:: https://img.shields.io/badge/Jenkins-ts__rotgui-green.svg
    :target: https://tssw-ci.lsst.org/job/LSST_Telescope-and-Site/job/ts_rotgui
...
This module is the rotator Python QT-based GUI.
...
The released version is `here <https://github.com/lsst-ts/ts_rotgui/releases>`_.
...
To contribute, please start a new pull request on `GitHub <https://github.com/lsst-ts/ts_rotgui>`_.
Feature requests shall be filled in JIRA with the *ts_rotgui* label.
